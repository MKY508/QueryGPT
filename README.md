...
## 🚀 最新更新 v2.4.0 (2025-08-28)

### 核心功能增强
- **智能路由系统**：根据查询复杂度自动选择执行路径，简单查询快速返回，复杂分析提供完整功能
- **停止功能优化**：解决了查询中断时后台进程继续运行的问题，实现完整的进程管理
- **新手引导改进**：首次使用时显示交互式引导，完成后不再重复出现
- **提示词管理**：支持自定义不同场景的系统提示词，优化查询效果
